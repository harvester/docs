...
- **Linux OS.** [Elemental](https://github.com/rancher/elemental-toolkit) for SUSE Linux Micro 6.2 is at the core of Harvester and is an immutable Linux distribution designed to remove as much OS maintenance as possible in a Kubernetes cluster.
