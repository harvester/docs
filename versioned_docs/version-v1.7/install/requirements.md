...
<head>
  <link rel="canonical" href="https://docs.harvesterhci.io/v1.7/install/requirements"/>
</head>
...
- For best results, use [YES-certified hardware](https://www.suse.com/yesCertified/home#search?platforms=1361&platforms=1360&platforms=1355) for SUSE Linux Micro 5.5/6.0/6.1. Harvester is built on SUSE Linux Enterprise technology and YES-certified hardware has additional validation of driver and system board compatibility. Laptops and nested virtualization are not supported.
