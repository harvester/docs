...
<head>
  <link rel="canonical" href="https://docs.harvesterhci.io/v1.9/advanced/addons/virtual-machine-auto-balance"/>
</head>
...
The **virtual-machine-auto-balance** add-on is classified as *experimental* in Harvester v1.9.0 and reaches general availability (GA) in v1.9.1. For more information about feature maturity, see [Feature Labels](../../getting-started/document-conventions.md#feature-labels).
