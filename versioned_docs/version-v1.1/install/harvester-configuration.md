...
<head>
  <link rel="canonical" href="https://docs.harvesterhci.io/v1.3/install/harvester-configuration"/>
</head>
...
| SHA-256 | `openssl passwd -5` | Yes (started from v1.1.2) |
| MD5 | `openssl passwd -1` | Yes (started from v1.1.2) |
| MD5, Apache variant | `openssl passwd -apr1` | Yes (started from v1.1.2) |
| AIX-MD5 | `openssl passwd -aixmd5` | No |

:::info
  Only SHA-512 is supported before v1.1.2 release.
:::
