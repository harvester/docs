...
When upgrading to Harvester **v1.4.0**, which includes Longhorn **v1.7.2**, backing images may become corrupted because of [a known Longhorn issue](https://github.com/longhorn/longhorn/issues/10644).
