...
<head>
  <link rel="canonical" href="https://docs.harvesterhci.io/v1.7/upgrade/v1-4-2-to-v1-5-2"/>
</head>
...
You can directly upgrade from v1.4.2 to v1.5.2 because Harvester allows a maximum of one minor version upgrade for underlying components. Harvester v1.4.2 and v1.4.3 use the same minor version of RKE2 (v1.31), while Harvester v1.5.0, v1.5.1 and v1.5.2 use the next minor version (v1.32).
...
1. Select version **1.5.2**, and then click **Update**.
...
A [Longhorn issue](https://github.com/longhorn/longhorn/issues/11158) causes virtual machines that use migratable [RWX volumes](https://docs.harvesterhci.io/v1.5/rancher/csi-driver/#rwx-volumes-support) to restart unexpectedly when the CSI plugin pods are restarted. This issue affects Harvester v1.4.x and v1.5.x.
