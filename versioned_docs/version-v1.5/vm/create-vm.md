...
Based on the definition of VM, Harvester applies some `Affinity` rules automatically.

:::note

Do not edit those automatically applied rules, the manual changes are always amended by Harvester webhook.
