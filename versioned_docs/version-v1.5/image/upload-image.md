...
<head>
  <link rel="canonical" href="https://docs.harvesterhci.io/v1.9/image/upload-image"/>
</head>
...
For more information, see the [API reference](/v1.5/api/create-namespaced-virtual-machine-image).
