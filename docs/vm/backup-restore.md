...
1. Download the VM image from the existing cluster.
...
1. Use a server to host the image and make it accessible to the new cluster. You can use a simple HTTP server to host the image.
  ```
