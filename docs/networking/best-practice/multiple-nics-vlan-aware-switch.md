...
Specify the name and a VLAN ID that you want to create for the VLAN network <small>(You can specify the same VLAN ID in different namespaces if you have [Rancher multi-tenancy](https://docs.harvesterhci.io/latest/rancher/virtualization-management/#multi-tenancy) configured)</small>.
