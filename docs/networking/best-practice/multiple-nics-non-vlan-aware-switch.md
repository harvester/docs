...
The following diagram illustrates the cabling used for this guide:
   ...
   ![mulitple-nics-non-vlan-aware.png](/img/v1.1/networking/best-practice/mulitple-nics-non-vlan-aware.png)
...
If you need a VM to connect to the subnet of the Harvester hosts, you have to create a VLAN Network in Harvester with VLAN ID 1.
   ...
   ![mulitple-nics-non-vlan-aware-vlan1.png](/img/v1.1/networking/best-practice/mulitple-nics-non-vlan-aware-vlan1.png)
