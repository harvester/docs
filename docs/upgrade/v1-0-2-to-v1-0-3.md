...
![](./assets/known_issues/2640-stuck.png){: style="width:50%"}

The following are some steps to verify this issue happens:
...
- In the "Snapshots and Backup" pane, toggle the "Show System Hidden" switch and delete the latest system snapshot (which is just before the "Volume Head").

    ![](./assets/known_issues/2640-vol-3.png)

- The volume will continue rebuilding and the upgrade will continue.
