...
<head>
  <link rel="canonical" href="https://docs.harvesterhci.io/v1.7/troubleshooting/monitoring"/>
</head>
...
Based on the `Longhorn` `Volume` expansion guide, `Harvester` illustrates how to [expand the volume size](https://longhorn.io/docs/1.11.1/volumes-and-nodes/expansion/).
