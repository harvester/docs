...
- If the device path changes when you reattach the device or reboot the node, you must detach it from the virtual machine and follow the steps above to repeat enabling process.
