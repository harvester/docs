...
- `logReadyTimeout`: Number of minutes Harvester allows for the creation of the upgrade logging infrastructure. You can specify a value (enclosed in double quotes) from `"0"` to `"20"`. The default value is `"5"`.
