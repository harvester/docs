...
1. Pull the image `rancher/ui-plugin-catalog` with [latest tag](https://hub.docker.com/r/rancher/ui-plugin-catalog/tags) and then push it to your private registry.
