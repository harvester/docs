...
const slice_1 = __importDefault(require("@theme/ApiDemoPanel/Accept/slice"));
const slice_2 = __importDefault(
  require("@theme/ApiDemoPanel/Authorization/slice")
);
const slice_3 = __importDefault(require("@theme/ApiDemoPanel/Body/slice"));
const slice_4 = __importDefault(
  require("@theme/ApiDemoPanel/ContentType/slice")
);
const slice_5 = __importDefault(
  require("@theme/ApiDemoPanel/ParamOptions/slice")
);
const slice_6 = __importDefault(require("@theme/ApiDemoPanel/Response/slice"));
const slice_7 = __importDefault(require("@theme/ApiDemoPanel/Server/slice"));
