...
const FloatingButton_1 = __importDefault(
  require("@theme/ApiDemoPanel/FloatingButton")
);
  ...
  switch (file.type) {
    ...
    default:
      return react_1.default.createElement(
        ...
        react_1.default.createElement(
          "div",
          { className: "openapi-demo__file-name" },
          file.name
        )
      );
  }
...
function FormFileUpload({ placeholder, onChange }) {
  ...
  return react_1.default.createElement(
    ...
    react_1.default.createElement(
      ...
      {
        className: hover
          ? "openapi-demo__dropzone-hover"
          : "openapi-demo__dropzone",
        onDrop: handleDrop,
      ...
      file
        ...
        : react_1.default.createElement(
            "div",
            { className: "openapi-demo__dropzone-content" },
            placeholder
          )
    )
  );
